...
parm_anti_main <- function(n, p,  num_main = 2, num_sq = 0, num_inter = 3, ratio_gen){
...
parm_mix_main <- function(n, p, num_main = 2, num_sq = 0, num_inter = 3, ratio_gen){
...
parm_hier_main <- function(n, p,  num_main = 2, num_sq = 0, num_inter = 3, ratio_gen){
